<section class="closing-cta">
    ...
    <div class="container closing-cta__inner">
        ...
        <div><a class="button" href="{{ app(\App\Support\LocalizedUrl::class)->route('products') }}">{{ __('site.actions.discover') }} <span>↗</span></a><a class="arrow-link arrow-link--light" href="{{ app(\App\Support\LocalizedUrl::class)->route('contact') }}">{{ __('site.actions.contact_us') }} <span>↗</span></a></div>
    </div>
</section>
