        ...
        return $schema
            ->components([
                ...
                Section::make('Görseller')->schema([
                    FileUpload::make('main_image')->label('Ana görsel')->image()->disk('public')->directory('products')->maxSize(5120),
                    FileUpload::make('additional_images')->label('Ek görseller')->image()->multiple()->disk('public')->directory('products')->maxSize(5120),
                ])->columns(2),
