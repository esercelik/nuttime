...
final class MenuItem extends Model
{
    ...
    public function translationFor(string $locale): ?MenuItemTranslation
    {
        ...
        foreach (array_unique([$locale, config('nuttime.fallback_locale'), config('nuttime.default_locale')]) as $fallbackLocale) if ($translation = $translations->firstWhere('locale', $fallbackLocale)) return $translation;
        return null;
    }
}
